...
user.org:user:bram_arbiter:1.0\
user.org:user:generation_worker:1.0\
"
...
\
  ...
  # Create instance: generation_worker_1, and set properties
  set generation_worker_1 [ create_bd_cell -type ip -vlnv user.org:user:generation_worker:1.0 generation_worker_1 ]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins generation_worker_0/S00_AXI] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs bram_arbiter_0/S00_AXI/S00_AXI_reg] -force
